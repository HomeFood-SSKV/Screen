var myApp = angular.module('myApp', []);
  ...
  myApp.controller('WatchListMidCap50Controller', [ '$scope','$interval','$rootScope', '$http',
  function ($scope,$interval,$rootScope,$http) {
   ...
   var objHeader ={ url: cors_api_url ,
    method: "GET",
    params: {urlpath: "https://www.nseindia.com/live_market/dynaContent/live_watch/stock_watch/niftyMidcap50StockWatch.json"}}
    // 6 mins init 
    $scope.init=function(){
